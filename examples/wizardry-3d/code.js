...
export const env = {
  ...
  levels: {
    musty_cellars: {
      fog: { color: 0x1a1510 },
      lighting: { ambient: 0x665544, ambientIntensity: 0.55 },
    },
    flooded_crypts: {
      fog: { color: 0x0a1520 },
      lighting: { ambient: 0x445566, ambientIntensity: 0.5 },
    },
    fungal_warrens: {
      fog: { color: 0x0a1a0a },
      lighting: { ambient: 0x447744, ambientIntensity: 0.55 },
    },
    obsidian_vaults: {
      fog: { color: 0x0a0a1a },
      lighting: { ambient: 0x334466, ambientIntensity: 0.45 },
    },
    dragons_lair: {
      fog: { color: 0x200a00 },
      lighting: { ambient: 0x774422, ambientIntensity: 0.5 },
    },
    frozen_catacombs: {
      fog: { color: 0x1a2535 },
      lighting: { ambient: 0x5577aa, ambientIntensity: 0.5 },
    },
    infernal_pit: {
      fog: { color: 0x300800 },
      lighting: { ambient: 0x883311, ambientIntensity: 0.45 },
    },
  },
};
