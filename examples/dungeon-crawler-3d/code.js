...
export const env = {
  ...
  levels: {
    stone_crypt: {
      fog: { color: 0x0a0a18 },
      lighting: { ambient: 0xccccee },
      accent: 0x6666aa,
      torchColor: 0xff8833,
    },
    mossy_sewer: {
      fog: { color: 0x081008 },
      lighting: { ambient: 0x88ddaa },
      accent: 0x44aa66,
      torchColor: 0x66ff88,
    },
    bone_catacombs: {
      fog: { color: 0x100c08 },
      lighting: { ambient: 0xeeddcc },
      accent: 0xccaa88,
      torchColor: 0xffaa44,
    },
    frozen_depths: {
      fog: { color: 0x0a1020 },
      lighting: { ambient: 0xaaccff },
      accent: 0x88bbff,
      torchColor: 0x44ccff,
    },
    inferno_pits: {
      fog: { color: 0x180808 },
      lighting: { ambient: 0xff8866 },
      accent: 0xff4422,
      torchColor: 0xff3300,
    },
    the_void: {
      fog: { color: 0x08041a },
      lighting: { ambient: 0xcc88ff },
      accent: 0xaa44ff,
      torchColor: 0xdd55ff,
    },
  },
